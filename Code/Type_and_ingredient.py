...
df_ingred=df_ingred.rename(columns={'Catalog No.':'Product_ID','Filtered_Ingredients':'Filtered_Ingredients'})
df_ingred
...
df_all.columns=['Combination','Count','Dry','Count','Oily','Count','Normal','Count']
df_all
